...
class _MipsFamily_mixin:
    @property
    def Word(self):
        return self.BitVector[sizes.WordLen]

    @property
    def Idx(self):
        return self.BitVector[sizes.IdxLen]


class PyFamily(_MipsFamily_mixin, family.PyFamily):
...
class SMTFamily(_MipsFamily_mixin, family.SMTFamily):
